...
# Note order of operations can be abbreviated as PEMDAS:
# Parentheses, Exponents, Multiplication, Division, Addition, Subtraction
# As a practical matter, Multiplication and Division happen in the first step
# from left to right, and then Addition and Subtraction occur from left to right.
...
print("Data type:", type(roosters))
print("Roosters", float(roosters))
print("Data type:", type(float(roosters)))
